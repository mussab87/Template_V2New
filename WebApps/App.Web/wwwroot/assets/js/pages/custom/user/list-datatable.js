...
var KTAppsUsersListDatatable = function () {
    ...
    var _demo = function () {
        ...
        //        source: {
        //            read: {
        //                url: '/Admin/GetUsersTest', // Your action URL
        //                method: 'GET',
        ...
        //    // columns definition - adjust field names to match your JSON response
        //    columns: [
        //        {
        //            field: 'id',
        //            title: 'Id',
        ...
        //            template: function (data) {
        //                var output = '';
        //                output = '<div class="d-flex align-items-right">\
        //                            <div class="ml-4">\
        ...
        //            title: 'First Name',
        //            template: function (row) {
        //                return '<div class="font-weight-bolder font-size-lg mb-0">' + row.firstName + '</div>';
        //            }
        //        }, {
        //            field: 'lastName',
        //            title: 'Last Name',
        //            template: function (row) {
        //                return '<div class="font-weight-bolder font-size-lg mb-0">' + row.lastName + '</div>';
        //            }
        //        }, {
        //            field: 'phoneNumber',
        //            title: 'Phone Number',
        //            template: function (row) {
        //                return '<div class="font-weight-bold text-muted">' + row.phoneNumber + '</div>';
        //            }
        //        }, {
        //            field: 'Actions',
        //            title: 'Actions',
        ...
        debugger
        var datatable = $('#kt_datatable').KTDatatable({
            // datasource definition - switch from remote to local
            data: {
                type: 'local',
                //source: localData,
                pageSize: 10, // display 10 records per page
                // Keep these if you want client-side processing
                // Remove if you want to handle everything in JavaScript
                serverPaging: false,
